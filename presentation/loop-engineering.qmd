...
subtitle: "why a really good prompt was never going to be enough"
...
::: {.kicker}
First chunk of the README flowchart — all judgment, no scripts yet. Nothing gets built until a behavior survives this.
:::
...
::: {.kicker}
The agent writes; the black boxes are the repo's shared scripts — one set, every video.
:::
...
## <i class="fa-solid fa-file-signature"></i> The core contract: `SKILL.md` {.smaller}
